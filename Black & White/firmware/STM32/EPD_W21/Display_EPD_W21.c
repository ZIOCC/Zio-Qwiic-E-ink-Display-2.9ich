...
//} 
/*********************************************
Function£ºThe first byte is written in the command, the rest is the parameter
...
/*********************************************
Function£ºWriting diaplay buffer
parameter£º 	XSize  x direction quantity  128points£¬adjust to multiples of 8
		YSize  y direction quantity	 	   	
		Dispbuff display data save location¡£ The data must be arranged correctly
*********************************************/
...
/*********************************************
Function£º  Writing display buffer used to write a region into the same display
parameter£º 	XSize  x direction quantity  128points, adjust to multiples of 8
		YSize  ydirection quantity	 	   	
...
/**********************************************************
parameter£º Label  
       =1 Display all of DisBuffer
	     =0 Display first byte of DisBuffer
***********************************************************/
...
parameter£º 
		xStart
			x direction start coordinate
		xEnd
			x direction end coordinate
		yStart
			y direction start coordinate
		yEnd
			y direction end coordinate
		DisBuffer
			display buffer
		Label  
       		=1 Display all of DisBuffer
